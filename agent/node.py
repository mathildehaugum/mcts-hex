class Node:
    def __init__(self, state, action):
        ...
        self.player = action[1]  # The player that performs an action from the state of this node (i.e. decides next state)
    ...
    def get_parent_counter(self):
        """ Returns the counter of the parent node, used to calculate the value of the node during MCTS"""
