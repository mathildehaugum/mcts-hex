...
num_episodes = 300  # ensure this is divisible by save-interval - 1 (e.g. 200/4 = 50 => saved episodes are 0, 50, 100, 150, 200)
num_simulations = 500
exploration_c = 1
...
# ----------------------------- NN PARAMETERS -----------------------------
epsilon = 1
decay_rate = 0.97  # >= 0.95 to allow adequate exploration
